        ...
        <main>
            <div class="container w-full h-full mx-auto px-2 py-20">
                ...
                <div class="mb-10">
                    ...
                    <!-- エラーメッセージ -->
                    <!-- <p class="text-red-600">エラーメッセーの表示</p> -->
                ...
                <div class="product-wrap px-5 py-10 shadow-md">
                    ...
                    <form action="kadai08_2.php" method="POST">
                        ...
                        <div class="flex flex-col sm:flex-row justify-end">
                            <a href="kadai06_1.php" class="text-white text-center leading-10 bg-gray-600 px-10 mr-0 sm:mr-5 hover:bg-gray-500 rounded-md">一覧へ戻る</a>
